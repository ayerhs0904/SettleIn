            ...
            <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1">
                ...
                <div className="mb-8 text-center sm:text-left">
                    ...
                    <p className="mt-2 text-lg text-gray-400">
                        Explore verified PGs and flats across top cities with SettleIn.
                    </p>
                </div>
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        {loading ? (
                            ...
                            <div className="bg-gray-800/50 border border-gray-700/60 rounded-2xl p-12 text-center space-y-3">
                                ...
                                <p className="text-sm text-gray-400">Try tweaking your search filters or clear them to see all listings.</p>
                            </div>
                        ) : (
                            <>
